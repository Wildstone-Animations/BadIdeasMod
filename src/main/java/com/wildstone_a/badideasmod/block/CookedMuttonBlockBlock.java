...
public class CookedMuttonBlockBlock extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:cookedmuttonblock")
	public static final Block block = null;
	public CookedMuttonBlockBlock(BADIDEASMODElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cookedmuttonblock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.COOKED_MUTTON, (int) (9)));
		}
	}
}
