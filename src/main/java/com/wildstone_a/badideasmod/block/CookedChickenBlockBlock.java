...
public class CookedChickenBlockBlock extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:cookedchickenblock")
	public static final Block block = null;
	public CookedChickenBlockBlock(BADIDEASMODElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cookedchickenblock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.COOKED_CHICKEN, (int) (9)));
		}
	}
}
