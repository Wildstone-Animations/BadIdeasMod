...
public class DirtStairsBlock extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:dirtstairs")
	public static final Block block = null;
	public DirtStairsBlock(BADIDEASMODElements instance) {
		super(instance, 27);
	}
