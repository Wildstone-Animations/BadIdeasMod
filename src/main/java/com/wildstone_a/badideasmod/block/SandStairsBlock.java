...
public class SandStairsBlock extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:sandstairs")
	public static final Block block = null;
	public SandStairsBlock(BADIDEASMODElements instance) {
		super(instance, 28);
	}
