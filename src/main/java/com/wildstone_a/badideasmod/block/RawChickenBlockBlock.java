...
public class RawChickenBlockBlock extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:rawchickenblock")
	public static final Block block = null;
	public RawChickenBlockBlock(BADIDEASMODElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rawchickenblock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.CHICKEN, (int) (9)));
		}
	}
}
