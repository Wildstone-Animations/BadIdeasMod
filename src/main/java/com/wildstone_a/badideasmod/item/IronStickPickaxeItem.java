...
public class IronStickPickaxeItem extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:ironstickpickaxe")
	public static final Item block = null;
	public IronStickPickaxeItem(BADIDEASMODElements instance) {
		super(instance, 8);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("ironstickpickaxe"));
	}
}
