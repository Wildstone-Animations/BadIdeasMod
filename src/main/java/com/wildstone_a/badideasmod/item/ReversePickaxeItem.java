...
public class ReversePickaxeItem extends BADIDEASMODElements.ModElement {
	@ObjectHolder("badideasmod:reversepickaxe")
	public static final Item block = null;
	public ReversePickaxeItem(BADIDEASMODElements instance) {
		super(instance, 5);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("reversepickaxe"));
	}
}
